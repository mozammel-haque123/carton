...
const Bannar = () => {
  const location = useLocation()
    return (
        <div> 
             <h1 className="text-center">rased</h1>
    ...
    <div className='flex flex-col ff'>
      <h1 className='md:text-7xl text-5xl font-medium md:font-bold flex gap-4 text-white'> <img src={bubel} className='w-50 absolute -top-24 -left-26 border' alt="" /> <span className='italic'>THE</span> <img className='md:w-30 w-20' src={portal} alt="PORTAL" /> <span className='text-transparent bg-clip-text bg-gradient-to-r from-[#05fbff] to-[#00fc08]'>RICK & </span> <img src={pill} className='h-2 absolute right-0' alt="" /> </h1>
    ...
    <img className='md:w-50 md:h-60 w-30 absolute z-10 lg:-right-40 md:-right-28 md:top-0 -right-10 top-10' src={gun} alt="" /> 
      ...
      <div className="flex flex-col-reverse md:flex-row md:justify-center md:items-center items-start justify-start border gap-5 mr-40 md:mr-0 md:gap-20 md:mt-10 mt-20">
